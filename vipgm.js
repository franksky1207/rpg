(function(){
 ...
 window.gmTestEnhancementLabel=function(){return `強化｜${enhancementSlots().map(type=>`${(window.ENHANCEMENT_SLOT_LABELS&&window.ENHANCEMENT_SLOT_LABELS[type])||type} +${window.gmTestEnhancementLevel(type)}`).join("｜")}`;};
