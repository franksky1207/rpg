(function(){
 ...
 if(typeof window.enhancementUpgradeCost!=="function")fail("COST_FUNCTION","缺少強化成本函式");
  ...
  const checks=[[1,100,5],[10,1000,50],[20,2000,100]];
  checks.forEach(([lv,basic,advanced])=>{const cost=window.enhancementUpgradeCost(lv);if(cost.basic!==basic||cost.advanced!==advanced)fail("COST_FORMULA",`+${lv} 成本異常`,cost);});
 }
