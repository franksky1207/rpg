(function(){
 const REGION_MAPS=[
  ...
  {chapter:"星際邊疆",name:"邊疆工業星",min:181,max:185,gear:["工業震裂刃","重工戰盔","重工強化甲","磁軌作業靴","工業控制核心"],enemies:[["工業護衛機",181,"normal","balanced"],["採掘戰兵",182,"normal","attack"],["重工戰鬥體",183,"normal","tank"],["工業攻城機",184,"elite","attack"],["邊疆工業主腦",185,"boss","tank"]]},
