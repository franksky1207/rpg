(function(){
 const REGION_MAPS=[
  ...
  {chapter:"星際邊疆",name:"星際傭兵港",min:156,max:160,gear:["傭兵脈衝刃","私軍戰盔","雇傭重甲","星港突進靴","傭兵識別牌"],enemies:[["星際傭兵",156,"normal","balanced"],["私軍突擊兵",157,"normal","attack"],["賞金獵兵",158,"normal","tank"],["重裝傭兵機",159,"elite","attack"],["傭兵港軍頭",160,"boss","tank"]]},
  {chapter:"星際邊疆",name:"遠征補給線",min:161,max:165,gear:["遠征切割刃","補給戰盔","遠征防護甲","航線推進靴","補給調度模組"],enemies:[["補給護衛兵",161,"normal","balanced"],["航線巡弋機",162,"normal","tank"],["遠征火力體",163,"normal","attack"],["重型補給艦",164,"elite","tank"],["遠征補給司令",165,"boss","balanced"]]},
  {chapter:"星際邊疆",name:"異星叢林殖民地",min:166,max:170,gear:["異星獵刃","生態戰盔","殖民適應甲","叢林機動靴","異星生態儀"],enemies:[["異星獵獸",166,"normal","attack"],["殖民偵察兵",167,"normal","balanced"],["生態獵兵體",168,"normal","attack"],["叢林重裝獸",169,"elite","tank"],["異星殖民母巢",170,"boss","tank"]]},
