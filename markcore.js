(function(){
 ...
 const MARK_DEFS=Object.freeze({
  ward:Object.freeze({id:"ward",name:"護界印記",unlockLevel:50}),
  suppression:Object.freeze({id:"suppression",name:"壓制印記",unlockLevel:100}),
  composure:Object.freeze({id:"composure",name:"鎮心印記",unlockLevel:150}),
  indomitable:Object.freeze({id:"indomitable",name:"不屈印記",unlockLevel:200}),
  resilience:Object.freeze({id:"resilience",name:"韌性印記",unlockLevel:250}),
  battleSpirit:Object.freeze({id:"battleSpirit",name:"戰意印記",unlockLevel:300}),
  absorption:Object.freeze({id:"absorption",name:"吸收印記",unlockLevel:350}),
  revenge:Object.freeze({id:"revenge",name:"復仇印記",unlockLevel:400}),
  backlash:Object.freeze({id:"backlash",name:"反噬印記",unlockLevel:450}),
  ignore:Object.freeze({id:"ignore",name:"無視印記",unlockLevel:500})
 });
 ...
 function effectSnapshot(key,level){
  ...
  if(key==="battleSpirit")return {...base,activationChance:activationChance(lv),atkPercentPerLayer:lv*.2,maxLayers:10};
