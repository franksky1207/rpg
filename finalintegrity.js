(function(){
 ...
 function run(){
  ...
  if(Number(window.CALAMITY_CORE_VERSION)!==1||Number(window.CALAMITY_RUN_VERSION)!==1||Number(window.CALAMITY_UI_VERSION)!==1||Number(window.GM_CALAMITY_TEST_VERSION)!==1)fail("FINAL_CALAMITY_VERSION","文明災厄版本鏈異常",{core:window.CALAMITY_CORE_VERSION,run:window.CALAMITY_RUN_VERSION,ui:window.CALAMITY_UI_VERSION,gm:window.GM_CALAMITY_TEST_VERSION});
