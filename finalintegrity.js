(function(){
 ...
 function run(){
  ...
  if(Number(window.PLAYER_TITLE_STATE_VERSION)!==1||Number(window.PLAYER_TITLE_UI_VERSION)!==1||Number(window.PLAYER_TITLE_INTEGRITY_VERSION)!==4||Number(window.GM_PLAYER_TITLE_PREVIEW_VERSION)!==3||!Array.isArray(window.CIVILIZATION_PLAYER_TITLE_DEFS)||window.CIVILIZATION_PLAYER_TITLE_DEFS.length!==10||!Array.isArray(window.MIRROR_PLAYER_TITLE_DEFS)||window.MIRROR_PLAYER_TITLE_DEFS.length!==6||!Array.isArray(window.PLAYER_TITLE_DEFS)||window.PLAYER_TITLE_DEFS.length!==16)fail("FINAL_PLAYER_TITLE","玩家稱號核心／災厄10＋鏡像6／GM 16稱號實戰名稱預覽／Integrity 鏈異常",{state:window.PLAYER_TITLE_STATE_VERSION,ui:window.PLAYER_TITLE_UI_VERSION,integrity:window.PLAYER_TITLE_INTEGRITY_VERSION,gm:window.GM_PLAYER_TITLE_PREVIEW_VERSION,calamity:window.CIVILIZATION_PLAYER_TITLE_DEFS?.length,mirror:window.MIRROR_PLAYER_TITLE_DEFS?.length,total:window.PLAYER_TITLE_DEFS?.length});
