(function(){
 ...
 function run(){
  ...
  if(Number(window.COMBAT_MARK_INTEGRATION_VERSION)!==1||Number(window.COMBAT_MARK_FX_VERSION)!==1)fail("FINAL_MARK_COMBAT_VERSION","印記 Combat／FX 版本異常",{combat:window.COMBAT_MARK_INTEGRATION_VERSION,fx:window.COMBAT_MARK_FX_VERSION});
  if(Number(window.CALAMITY_CORE_VERSION)!==1||Number(window.CALAMITY_RUN_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_RULE_VERSION)!==2||Number(window.CALAMITY_UI_VERSION)!==3||Number(window.GM_CALAMITY_TEST_VERSION)!==1)fail("FINAL_CALAMITY_VERSION","文明災厄版本鏈異常",{core:window.CALAMITY_CORE_VERSION,run:window.CALAMITY_RUN_VERSION,rules:window.CALAMITY_CONTINUOUS_RULE_VERSION,ui:window.CALAMITY_UI_VERSION,gm:window.GM_CALAMITY_TEST_VERSION});
