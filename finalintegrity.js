(function(){
 ...
 function run(){
  ...
  if(Number(window.EQUIPMENT_ENHANCEMENT_PIPELINE_VERSION)!==3||typeof window.handleUnequippedItem!=="function"||typeof window.equipmentSellSelected!=="function"||typeof window.equipmentSellLowerAll!=="function")fail("FINAL_EQUIPMENT_SALE_PIPELINE","裝備出售 pipeline 未完整接入統一 sale owner",{version:window.EQUIPMENT_ENHANCEMENT_PIPELINE_VERSION,unequip:typeof window.handleUnequippedItem,single:typeof window.equipmentSellSelected,batch:typeof window.equipmentSellLowerAll});
