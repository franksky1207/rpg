(function(){
 ...
 function run(){
  ...
  if(Number(window.SECOND_WORLD_REWARD_VERSION)!==1||Number(window.SECOND_WORLD_REDEMPTION_MULTIPLIER)!==10||typeof window.secondWorldBossExpReward!=="function"||typeof window.secondWorldBossDarkMatterReward!=="function"||typeof window.makeSecondWorldEquipmentForBoss!=="function"||typeof window.settleSecondWorldBossVictory!=="function"||typeof window.applySecondWorldDeathPenalty!=="function")fail("FINAL_SECOND_WORLD_REWARDS","宇宙紀元主線獎勵／裝備 owner 未完整載入",{version:window.SECOND_WORLD_REWARD_VERSION,redemption:window.SECOND_WORLD_REDEMPTION_MULTIPLIER,xp:typeof window.secondWorldBossExpReward,dm:typeof window.secondWorldBossDarkMatterReward,item:typeof window.makeSecondWorldEquipmentForBoss,settle:typeof window.settleSecondWorldBossVictory,death:typeof window.applySecondWorldDeathPenalty});
  if(Number(window.SECOND_WORLD_MAINLINE_VERSION)!==3||Number(window.SECOND_WORLD_BACKGROUND_GM_GATE_VERSION)!==1||typeof window.startSecondWorldBossBattle!=="function"||typeof window.startSecondWorldBossContinuous!=="function"||typeof window.requestSecondWorldContinuousStop!=="function"||typeof window.secondWorldMainlinePresentationActive!=="function"||typeof window.secondWorldBackgroundBattleEnabled!=="function")fail("FINAL_SECOND_WORLD_MAINLINE","宇宙紀元正式主線／連續戰鬥／演出 owner 未完整載入",{version:window.SECOND_WORLD_MAINLINE_VERSION,backgroundGate:window.SECOND_WORLD_BACKGROUND_GM_GATE_VERSION,start:typeof window.startSecondWorldBossBattle,continuous:typeof window.startSecondWorldBossContinuous,stop:typeof window.requestSecondWorldContinuousStop,presentation:typeof window.secondWorldMainlinePresentationActive,background:typeof window.secondWorldBackgroundBattleEnabled});
  ...
  if(Number(window.GM_POWER_BENCHMARK_VERSION)!==11||Number(window.GM_POWER_BENCHMARK_BATCH_SIZE)!==25||typeof window.gmPowerBenchmarkRunCombat!=="function"||typeof window.gmPowerBenchmarkRunUniverseCombat!=="function"||typeof window.gmPowerBenchmarkSetUniverseRegion!=="function"||typeof window.gmPowerBenchmarkSetUniverseBoss!=="function"||typeof window.gmPowerBenchmarkIsBusy!=="function"||typeof window.gmPowerBenchmarkSummaryText!=="function"||typeof window.gmPowerBenchmarkCopySummary!=="function"||typeof window.gmPowerBenchmarkReset!=="function")fail("FINAL_GM_POWER_BENCHMARK","GM 戰力基準測試 V11 未完整載入",{version:window.GM_POWER_BENCHMARK_VERSION,batch:window.GM_POWER_BENCHMARK_BATCH_SIZE,combat:typeof window.gmPowerBenchmarkRunCombat,universe:typeof window.gmPowerBenchmarkRunUniverseCombat,universeRegion:typeof window.gmPowerBenchmarkSetUniverseRegion,busy:typeof window.gmPowerBenchmarkIsBusy});
