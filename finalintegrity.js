(function(){
 ...
 function run(){
  ...
  if(Number(window.STRUCTURED_COMBAT_PACING_VERSION)!==1||typeof window.getStructuredCombatPacing!=="function")fail("FINAL_STRUCTURED_COMBAT_PACING","戰鬥內動畫共用 Pacing V1 未載入",{version:window.STRUCTURED_COMBAT_PACING_VERSION,api:typeof window.getStructuredCombatPacing});
