(function(){
 ...
 function run(){
  ...
  if(Number(window.GM_POWER_BENCHMARK_VERSION)!==3||typeof window.gmPowerBenchmarkRunCombat!=="function"||typeof window.gmPowerBenchmarkSummaryText!=="function"||typeof window.gmPowerBenchmarkCopySummary!=="function")fail("FINAL_GM_POWER_BENCHMARK","GM 戰力基準測試 V3 未完整載入",{version:window.GM_POWER_BENCHMARK_VERSION,combat:typeof window.gmPowerBenchmarkRunCombat,summary:typeof window.gmPowerBenchmarkSummaryText,copy:typeof window.gmPowerBenchmarkCopySummary});
