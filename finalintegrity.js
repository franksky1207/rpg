(function(){
 ...
 function run(){
  ...
  if(Number(window.MARK_CORE_VERSION)!==1||Number(window.MARK_COMBAT_RULE_VERSION)!==1)fail("FINAL_MARK_VERSION","Mark Core 版本異常",{core:window.MARK_CORE_VERSION,rules:window.MARK_COMBAT_RULE_VERSION});
