(function(){
 ...
 function run(){
  ...
  if(Number(window.ARENA_BALANCE_VERSION)!==5||Number(window.ARENA_RANK_BALANCE_VERSION)!==2)fail("FINAL_ARENA_BALANCE","Arena Balance V5／Rank Balance V2 異常",{balance:window.ARENA_BALANCE_VERSION,rankBalance:window.ARENA_RANK_BALANCE_VERSION});
