(function(){
 ...
 function run(){
  ...
  if(Number(window.CALAMITY_BALANCE_VERSION)!==2||Number(window.CALAMITY_FIXED_HP)!==1000000||Number(window.CALAMITY_CORE_VERSION)!==1||Number(window.CALAMITY_COMBAT_RULE_VERSION)!==2||Number(window.CALAMITY_RUN_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_RULE_VERSION)!==2||Number(window.CALAMITY_UI_VERSION)!==3||Number(window.GM_CALAMITY_TEST_VERSION)!==1)fail("FINAL_CALAMITY_VERSION","文明災厄版本鏈／固定 HP 異常",{balance:window.CALAMITY_BALANCE_VERSION,hp:window.CALAMITY_FIXED_HP,core:window.CALAMITY_CORE_VERSION,combatRules:window.CALAMITY_COMBAT_RULE_VERSION,run:window.CALAMITY_RUN_VERSION,rules:window.CALAMITY_CONTINUOUS_RULE_VERSION,ui:window.CALAMITY_UI_VERSION,gm:window.GM_CALAMITY_TEST_VERSION});
