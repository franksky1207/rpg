(function(){
 ...
 function run(){
  ...
  if(Number(window.ARENA_BALANCE_VERSION)!==4||Number(window.ARENA_RANK_BALANCE_VERSION)!==1)fail("FINAL_ARENA_BALANCE","Arena Balance V4／Rank Balance V1 異常",{balance:window.ARENA_BALANCE_VERSION,rankBalance:window.ARENA_RANK_BALANCE_VERSION});
