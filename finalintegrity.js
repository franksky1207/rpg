(function(){
 ...
 function run(){
  ...
  if(Number(window.BACKGROUND_PROGRESS_SINGLE_ACTIVE_FLOW_VERSION)!==1||Number(window.BACKGROUND_PROGRESS_UI_YIELD_VERSION)!==2||typeof window.backgroundProgressActiveKind!=="function")fail("FINAL_BACKGROUND_FLOW_POLICY","Background single-active-flow／paint-yield V2 未載入",{single:window.BACKGROUND_PROGRESS_SINGLE_ACTIVE_FLOW_VERSION,yield:window.BACKGROUND_PROGRESS_UI_YIELD_VERSION});
  if(Number(window.COMBAT_OUTER_PACING_VERSION)!==1||typeof window.combatOuterGapMs!=="function")fail("FINAL_COMBAT_OUTER_PACING","Combat Outer Pacing owner 未載入",{version:window.COMBAT_OUTER_PACING_VERSION,api:typeof window.combatOuterGapMs});
  ...
  if(Number(window.CALAMITY_BALANCE_VERSION)!==2||Number(window.CALAMITY_FIXED_HP)!==1000000||Number(window.CALAMITY_CORE_VERSION)!==1||Number(window.CALAMITY_COMBAT_RULE_VERSION)!==2||Number(window.CALAMITY_HP_RESTORE_OWNER_VERSION)!==1||Number(window.CALAMITY_RUN_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_RULE_VERSION)!==3||Number(window.CALAMITY_UI_VERSION)!==3||Number(window.CALAMITY_BATTLE_VIEW_VERSION)!==1||Number(window.CALAMITY_OUTER_PACING_VERSION)!==1||Number(window.GM_CALAMITY_TEST_VERSION)!==1||Number(window.GM_MARK_CONFIG_OWNER_VERSION)!==1)fail("FINAL_CALAMITY_VERSION","文明災厄版本鏈／固定 HP 異常",{balance:window.CALAMITY_BALANCE_VERSION,hp:window.CALAMITY_FIXED_HP,core:window.CALAMITY_CORE_VERSION,combatRules:window.CALAMITY_COMBAT_RULE_VERSION,restoreOwner:window.CALAMITY_HP_RESTORE_OWNER_VERSION,run:window.CALAMITY_RUN_VERSION,rules:window.CALAMITY_CONTINUOUS_RULE_VERSION,ui:window.CALAMITY_UI_VERSION,battleView:window.CALAMITY_BATTLE_VIEW_VERSION,outer:window.CALAMITY_OUTER_PACING_VERSION,gm:window.GM_CALAMITY_TEST_VERSION,gmConfigOwner:window.GM_MARK_CONFIG_OWNER_VERSION});
