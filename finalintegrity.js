(function(){
 ...
 function run(){
  ...
  if(Number(window.SECOND_WORLD_MAINLINE_VERSION)!==2||Number(window.SECOND_WORLD_BACKGROUND_GM_GATE_VERSION)!==1||typeof window.startSecondWorldBossBattle!=="function"||typeof window.startSecondWorldBossContinuous!=="function"||typeof window.requestSecondWorldContinuousStop!=="function"||typeof window.secondWorldBackgroundBattleEnabled!=="function")fail("FINAL_SECOND_WORLD_MAINLINE","宇宙紀元正式主線／連續戰鬥 owner 未完整載入",{version:window.SECOND_WORLD_MAINLINE_VERSION,backgroundGate:window.SECOND_WORLD_BACKGROUND_GM_GATE_VERSION,start:typeof window.startSecondWorldBossBattle,continuous:typeof window.startSecondWorldBossContinuous,stop:typeof window.requestSecondWorldContinuousStop,background:typeof window.secondWorldBackgroundBattleEnabled});
