(function(){
 ...
 function run(){
  ...
  if(Number(window.FIRST_WORLD_ENHANCEMENT_CAP)!==20||Number(window.SECOND_WORLD_ENHANCEMENT_CAP)!==40||window.SECOND_WORLD_ENHANCEMENT_EXTENSION_ACTIVE!==true||Number(window.ENHANCEMENT_MAX_LEVEL)!==20)fail("FINAL_ENHANCEMENT_WORLD_CAPS","強化世界 cap owner／宇宙高階強化啟用狀態異常",{first:window.FIRST_WORLD_ENHANCEMENT_CAP,second:window.SECOND_WORLD_ENHANCEMENT_CAP,extensionActive:window.SECOND_WORLD_ENHANCEMENT_EXTENSION_ACTIVE,activeMax:window.ENHANCEMENT_MAX_LEVEL});
