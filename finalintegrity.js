(function(){
 ...
 function run(){
  ...
  if(Number(window.BOUNTY_BALANCE_VERSION)!==1||Number(window.BOUNTY_DIFFICULTY_FORMULA_VERSION)!==1||typeof window.getBountyDifficultyProfile!=="function")fail("FINAL_BOUNTY_BALANCE","Bounty Balance V1／Difficulty Formula V1 異常",{balance:window.BOUNTY_BALANCE_VERSION,formula:window.BOUNTY_DIFFICULTY_FORMULA_VERSION});
  ...
  if(Number(window.ARENA_BALANCE_VERSION)!==6||Number(window.ARENA_RANK_BALANCE_VERSION)!==3)fail("FINAL_ARENA_BALANCE","Arena Balance V6／Rank Balance V3 異常",{balance:window.ARENA_BALANCE_VERSION,rankBalance:window.ARENA_RANK_BALANCE_VERSION});
