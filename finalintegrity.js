(function(){
 ...
 function run(){
  ...
  if(Number(window.MARK_CORE_VERSION)!==1||Number(window.MARK_COMBAT_RULE_VERSION)!==1||Number(window.MARK_PROGRESSION_OWNER_VERSION)!==1)fail("FINAL_MARK_VERSION","Mark Core 版本／progression owner 異常",{core:window.MARK_CORE_VERSION,rules:window.MARK_COMBAT_RULE_VERSION,progression:window.MARK_PROGRESSION_OWNER_VERSION});
  if(Number(window.COMBAT_MARK_INTEGRATION_VERSION)!==1||Number(window.COMBAT_MARK_FX_VERSION)!==1||Number(window.COMBAT_PRESENTATION_VERSION)!==2||Number(window.COMBAT_PRESENTATION_UNIFIED_VERSION)!==1||Number(window.COMBAT_STRUCTURED_PRESENTATION_VERSION)!==1||Number(window.MIRROR_STRUCTURED_PRESENTATION_VERSION)!==1||Number(window.CALAMITY_STRUCTURED_PRESENTATION_VERSION)!==1)fail("FINAL_MARK_COMBAT_VERSION","印記 Combat／Unified Presentation 版本異常",{combat:window.COMBAT_MARK_INTEGRATION_VERSION,fx:window.COMBAT_MARK_FX_VERSION,presentation:window.COMBAT_PRESENTATION_VERSION,unified:window.COMBAT_PRESENTATION_UNIFIED_VERSION,structured:window.COMBAT_STRUCTURED_PRESENTATION_VERSION,mirror:window.MIRROR_STRUCTURED_PRESENTATION_VERSION,calamity:window.CALAMITY_STRUCTURED_PRESENTATION_VERSION});
  if(Number(window.CALAMITY_BALANCE_VERSION)!==2||Number(window.CALAMITY_FIXED_HP)!==1000000||Number(window.CALAMITY_CORE_VERSION)!==1||Number(window.CALAMITY_COMBAT_RULE_VERSION)!==2||Number(window.CALAMITY_HP_RESTORE_OWNER_VERSION)!==1||Number(window.CALAMITY_RUN_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_RULE_VERSION)!==3||Number(window.CALAMITY_UI_VERSION)!==3||Number(window.CALAMITY_CONTINUOUS_GAP_MS)!==350||Number(window.GM_CALAMITY_TEST_VERSION)!==1)fail("FINAL_CALAMITY_VERSION","文明災厄版本鏈／固定 HP 異常",{balance:window.CALAMITY_BALANCE_VERSION,hp:window.CALAMITY_FIXED_HP,core:window.CALAMITY_CORE_VERSION,combatRules:window.CALAMITY_COMBAT_RULE_VERSION,restoreOwner:window.CALAMITY_HP_RESTORE_OWNER_VERSION,run:window.CALAMITY_RUN_VERSION,rules:window.CALAMITY_CONTINUOUS_RULE_VERSION,ui:window.CALAMITY_UI_VERSION,gap:window.CALAMITY_CONTINUOUS_GAP_MS,gm:window.GM_CALAMITY_TEST_VERSION});
  if(Number(window.ARENA_ASSESSMENT_RUNTIME_VERSION)!==4)fail("FINAL_ARENA_ASSESSMENT","Arena Assessment 應為 V4",window.ARENA_ASSESSMENT_RUNTIME_VERSION);
