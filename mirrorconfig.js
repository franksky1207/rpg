(function(){
 const TITLE_UNLOCKS=Object.freeze([
  Object.freeze({wins:15,id:"mirror_title_15",name:"幸運眷顧"}),
  Object.freeze({wins:16,id:"mirror_title_16",name:"天選之刻"}),
  Object.freeze({wins:17,id:"mirror_title_17",name:"逆命者"}),
  Object.freeze({wins:18,id:"mirror_title_18",name:"傳說之日"}),
  Object.freeze({wins:19,id:"mirror_title_19",name:"距神一步"}),
  Object.freeze({wins:20,id:"mirror_title_20",name:"神蹟"})
 ]);
 const RECORD_TITLES=Object.freeze(Object.fromEntries(TITLE_UNLOCKS.map(row=>[row.wins,row.name])));
 const CONFIG=Object.freeze({
  ...
  titleUnlocks:TITLE_UNLOCKS,
  recordTitles:RECORD_TITLES,
