(function(){
 ...
 function injectStyles(){
  ...
  @media(max-width:760px){
   .void-shell{padding:0 4px 12px}.void-panel{padding:7px}.void-title{font-size:18px;margin-bottom:6px}.void-stats{grid-template-columns:repeat(4,minmax(0,1fr));gap:4px;margin-bottom:6px}.void-stat{padding:5px 3px;border-radius:7px}.void-stat span{font-size:10px;line-height:1.15}.void-stat strong{font-size:14px;margin-top:2px}.void-subtitle{margin:0 0 6px;font-size:12px}
 ...
 function idleHtml(){
  ...
  return `<section class="void-shell"><div class="card void-panel void-result"><div class="void-title">【虛空幻境】</div><h2>第 ${next} 層</h2><div class="muted">進入後會自動逐層挑戰；每層開始前完全恢復 HP，直到戰敗或強制退出。</div><div class="void-result-grid"><div><span>最高通過樓層</span><strong>第 ${p.highestCleared||0} 層</strong></div><div><span>剩餘可挑戰次數</span><strong>${d.attempts||0} 次</strong></div></div><div class="void-actions"><button class="btn" onclick="go('dungeon')">返回副本</button></div></div></section>`;
 }
