 ...
 function installStyles(){
  ...
  s.textContent=`
   ...
   @media(max-width:760px){
    ...
    .void-combat{padding:7px!important;border-radius:11px!important}.void-combat .combat-head{margin-bottom:5px!important;font-size:13px!important}
    .void-combat .combat-arena{gap:5px!important}.void-combat .combatant{padding:8px!important;min-height:0!important;border-radius:10px!important}
    .void-combat .combatant h2{font-size:18px!important;margin:3px 0 6px!important}.void-vs{font-size:17px!important;margin:1px 0!important}
