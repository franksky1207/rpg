(function(){
 const GUIDE_CATEGORIES=[
  ...
  {id:"gear",label:"角色與裝備",items:[
   ...
   ["裝備欄位強化","武器、頭盔、鎧甲、鞋子、飾品五個欄位都能永久強化，強化等級會保留在欄位上，不受更換裝備或戰敗遺失影響。現階段最高可強化至 +20。"],
   ["強化石","強化石可透過主線戰鬥、部分裝備出售與離線刷怪取得，其中離線只能獲得少量基礎強化石。玩家高於怪物 10 級（含）以上時，主線戰鬥將不再掉落強化石；特殊怪與副本也不會掉落強化石。"]
  ]},
  ...
  {id:"growth",label:"成長與功能",items:[
   ...
   ["省電模式","連續戰鬥中可切換為簡化顯示畫面，戰鬥仍會持續進行；滑動即可退出省電模式。"],
