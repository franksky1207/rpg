(function(){
 const SOLAR_MAPS=[
  ...
  {chapter:"太陽系戰爭",name:"火星殖民區",min:61,max:65,gear:["赤原脈衝刃","火星戰術盔","殖民防衛甲","赤塵機動靴","火星環境模組"],enemies:[["赤塵巡邏兵",61,"normal","balanced"],["殖民區暴走機",62,"normal","attack"],["火星工程戰體",63,"normal","tank"],["赤原鎮壓者",64,"elite","balanced"],["火星殖民總督",65,"boss","tank"]]},
  ...
  {chapter:"太陽系戰爭",name:"外太陽系邊境",min:91,max:95,gear:["深空切界刃","遠域探勘盔","深空生存甲","遠日推進靴","深空航標"],enemies:[["邊境巡弋者",91,"normal","balanced"],["深空獵兵",92,"normal","attack"],["遠日戰鬥體",93,"normal","tank"],["黑域追擊艦",94,"elite","attack"],["外域守門者",95,"boss","tank"]]},
