(function(){
 const SOLAR_MAPS=[
  {chapter:"太陽系戰爭",name:"月面登陸區",min:51,max:55,gear:["月塵振動刃","低重力作戰盔","月面複合甲","真空磁吸靴","月面導航晶片"],enemies:[["月塵斥候",51,"normal","attack"],["低重力獵兵",52,"normal","balanced"],["月面自律炮台",53,"normal","tank"],["銀灰裝甲兵",54,"elite","tank"],["月面封鎖者",55,"boss","balanced"]]},
  ...
  {chapter:"太陽系戰爭",name:"火星殖民區",min:61,max:65,gear:["赤原脈衝刃","火星戰術盔","殖民防衛甲","赤塵機動靴","火星環境模組"],enemies:[["赤塵巡邏兵",61,"normal","balanced"],["殖民區暴走機",62,"normal","attack"],["火星工程機兵",63,"normal","tank"],["赤原鎮壓者",64,"elite","balanced"],["火星殖民總督",65,"boss","tank"]]},
  ...
  {chapter:"太陽系戰爭",name:"小行星採礦帶",min:71,max:75,gear:["礦脈震裂刃","採礦重盔","工業強化甲","零重力磁靴","礦帶掃描器"],enemies:[["採礦護衛機",71,"normal","balanced"],["漂移海盜兵",72,"normal","attack"],["爆破無人機",73,"normal","attack"],["採掘攻堅機",74,"elite","tank"],["小行星掠奪王",75,"boss","balanced"]]},
  {chapter:"太陽系戰爭",name:"木衛戰區",min:76,max:80,gear:["冰月能量刃","冰殼戰盔","低溫動力甲","冰面推進靴","木衛導航核"],enemies:[["冰月哨兵",76,"normal","balanced"],["木衛獵殺體",77,"normal","attack"],["低溫戰鬥機",78,"normal","attack"],["冰殼攻城獸",79,"elite","tank"],["木衛戰區霸主",80,"boss","tank"]]},
  ...
  {chapter:"太陽系戰爭",name:"土星環防線",min:86,max:90,gear:["環帶光刃","碎冰防衛盔","環軌防護甲","環帶機動靴","土星環定位器"],enemies:[["環帶偵察機",86,"normal","attack"],["碎冰突擊兵",87,"normal","balanced"],["環軌炮衛",88,"normal","tank"],["土星環堡壘艦",89,"elite","tank"],["環帶防線統帥",90,"boss","balanced"]]},
