(function(){
 ...
 if(Number(window.GAME_GUIDE_VERSION)!==17||Number(window.GAME_GUIDE_CALAMITY_WORLD_VERSION)!==1)fail("GUIDE_VERSION",`遊戲說明應為 V17 並具備文明災厄雙紀元語意，實際 ${window.GAME_GUIDE_VERSION}`);
