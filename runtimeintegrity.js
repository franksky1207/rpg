(function(){
 ...
 if(Number(window.COMBAT_STRUCTURED_PRESENTATION_VERSION)!==1||Number(window.MIRROR_STRUCTURED_PRESENTATION_VERSION)!==1||Number(window.CALAMITY_STRUCTURED_PRESENTATION_VERSION)!==1||Number(window.COMBAT_PRESENTATION_UNIFIED_VERSION)!==1)fail("COMBAT_STRUCTURED_PRESENTATION_VERSION","Unified Structured Presentation 版本異常",{structured:window.COMBAT_STRUCTURED_PRESENTATION_VERSION,mirror:window.MIRROR_STRUCTURED_PRESENTATION_VERSION,calamity:window.CALAMITY_STRUCTURED_PRESENTATION_VERSION,unified:window.COMBAT_PRESENTATION_UNIFIED_VERSION});
 ...
 if(Number(window.CALAMITY_CORE_VERSION)!==1||Number(window.CALAMITY_COMBAT_RULE_VERSION)!==2||Number(window.COMBAT_PERSISTENT_ENEMY_HP_VERSION)!==1)fail("CALAMITY_CORE_VERSION","文明災厄 Core／持久敵方 HP 版本異常",{core:window.CALAMITY_CORE_VERSION,rules:window.CALAMITY_COMBAT_RULE_VERSION,persistentHp:window.COMBAT_PERSISTENT_ENEMY_HP_VERSION});
 if(Number(window.CALAMITY_RUN_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_RULE_VERSION)!==2||Number(window.CALAMITY_CONTINUOUS_GAP_MS)!==350)fail("CALAMITY_RUN_VERSION","文明災厄 runtime／連戰節奏版本異常",{run:window.CALAMITY_RUN_VERSION,rules:window.CALAMITY_CONTINUOUS_RULE_VERSION,gap:window.CALAMITY_CONTINUOUS_GAP_MS});
 if(Number(window.CALAMITY_UI_VERSION)!==3||Number(window.CALAMITY_MINIMAL_MODE_VERSION)!==1)fail("CALAMITY_UI_VERSION","文明災厄 UI／極簡模式版本異常",{ui:window.CALAMITY_UI_VERSION,minimal:window.CALAMITY_MINIMAL_MODE_VERSION});
 if(Number(window.GM_CALAMITY_TEST_VERSION)!==1||Number(window.GM_MARK_MANAGEMENT_VERSION)!==1||Number(window.GM_CALAMITY_FULL_KILL_SAFETY_LIMIT)!==100000)fail("CALAMITY_GM_VERSION","文明災厄／印記 GM 版本異常",{calamity:window.GM_CALAMITY_TEST_VERSION,marks:window.GM_MARK_MANAGEMENT_VERSION,safety:window.GM_CALAMITY_FULL_KILL_SAFETY_LIMIT});
