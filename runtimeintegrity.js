(function(){
 ...
 if(Number(window.STRUCTURED_COMBAT_PACING_VERSION)!==1||typeof window.getStructuredCombatPacing!=="function")fail("STRUCTURED_COMBAT_PACING_OWNER","戰鬥內動畫應由單一 Structured Combat Pacing V1 管理",{version:window.STRUCTURED_COMBAT_PACING_VERSION,api:typeof window.getStructuredCombatPacing});
