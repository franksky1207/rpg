(function(){
 ...
 if(Number(window.CALAMITY_CORE_VERSION)!==1||Number(window.CALAMITY_COMBAT_RULE_VERSION)!==1||Number(window.COMBAT_PERSISTENT_ENEMY_HP_VERSION)!==1)fail("CALAMITY_CORE_VERSION","文明災厄 Core／持久敵方 HP 版本異常",{core:window.CALAMITY_CORE_VERSION,rules:window.CALAMITY_COMBAT_RULE_VERSION,persistentHp:window.COMBAT_PERSISTENT_ENEMY_HP_VERSION});
 if(Number(window.CALAMITY_RUN_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_RULE_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_GAP_MS)!==350)fail("CALAMITY_RUN_VERSION","文明災厄 runtime／連戰節奏版本異常",{run:window.CALAMITY_RUN_VERSION,rules:window.CALAMITY_CONTINUOUS_RULE_VERSION,gap:window.CALAMITY_CONTINUOUS_GAP_MS});
