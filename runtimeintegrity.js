(function(){
 ...
 if(Number(window.CALAMITY_UI_VERSION)!==2||Number(window.CALAMITY_MINIMAL_MODE_VERSION)!==1)fail("CALAMITY_UI_VERSION","文明災厄 UI／極簡模式版本異常",{ui:window.CALAMITY_UI_VERSION,minimal:window.CALAMITY_MINIMAL_MODE_VERSION});
