(function(){
 ...
 if(Number(window.COMBAT_STRUCTURED_PRESENTATION_VERSION)!==1||Number(window.MIRROR_STRUCTURED_PRESENTATION_VERSION)!==1)fail("COMBAT_STRUCTURED_PRESENTATION_VERSION","Structured／Mirror Structured Presentation 版本異常",{structured:window.COMBAT_STRUCTURED_PRESENTATION_VERSION,mirror:window.MIRROR_STRUCTURED_PRESENTATION_VERSION});
