(function(){
 ...
 if(Number(window.GM_PLAYER_ABILITY_TEST_GROUP_VERSION)!==1||typeof window.gmPlayerAbilityTestHtml!=="function")fail("GM_PLAYER_ABILITY_TEST_GROUP","角色能力測試大區未完整載入",{version:window.GM_PLAYER_ABILITY_TEST_GROUP_VERSION,renderer:typeof window.gmPlayerAbilityTestHtml});
