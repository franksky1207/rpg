(function(){
 ...
 if(Number(window.SECOND_WORLD_CALAMITY_FULL_INTEGRITY_VERSION)!==1||window.SECOND_WORLD_CALAMITY_FULL_INTEGRITY_REPORT?.passed!==true||typeof window.runSecondWorldCalamityFullIntegrity!=="function")fail("SECOND_WORLD_CALAMITY_FULL_INTEGRITY","第二世界文明災厄第 5 批完整 Integrity 未通過",window.SECOND_WORLD_CALAMITY_FULL_INTEGRITY_REPORT);
