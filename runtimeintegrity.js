(function(){
 ...
 if(Number(window.SECOND_WORLD_GM_CIVILIZATION_TEST_VERSION)!==1)fail("SECOND_WORLD_GM_CIVILIZATION_TEST","宇宙 Boss GM 測試尚未接入文明等級沙盒",window.SECOND_WORLD_GM_CIVILIZATION_TEST_VERSION);
