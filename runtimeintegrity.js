(function(){
 ...
 if(Number(window.GM_TEST_STATE_VERSION)!==1||Number(window.GM_ENHANCEMENT_TEST_PIPELINE_VERSION)!==5||Number(window.GM_ENHANCEMENT_HUB_VERSION)!==5||typeof window.gmRefreshTestControls!=="function"||typeof window.gmTestEnhancementSlots!=="function"||typeof window.gmClampTestEnhancementLevel!=="function"||typeof window.gmUseCurrentTestStatus!=="function")fail("GM_TEST_STATE_OWNER","GM 共用測試狀態 owner／刷新流程未完整載入",{stateVersion:window.GM_TEST_STATE_VERSION,pipeline:window.GM_ENHANCEMENT_TEST_PIPELINE_VERSION,hub:window.GM_ENHANCEMENT_HUB_VERSION,refresh:typeof window.gmRefreshTestControls,slots:typeof window.gmTestEnhancementSlots,clamp:typeof window.gmClampTestEnhancementLevel,sync:typeof window.gmUseCurrentTestStatus});
 if(Number(window.GM_POWER_BENCHMARK_VERSION)!==9||Number(window.GM_POWER_BENCHMARK_BATCH_SIZE)!==25||typeof window.gmPowerBenchmarkRunOutput!=="function"||typeof window.gmPowerBenchmarkRunDefense!=="function"||typeof window.gmPowerBenchmarkRunCombat!=="function"||typeof window.gmPowerBenchmarkIsBusy!=="function"||typeof window.gmPowerBenchmarkSummaryText!=="function"||typeof window.gmPowerBenchmarkCopySummary!=="function"||typeof window.gmPowerBenchmarkReset!=="function")fail("GM_POWER_BENCHMARK","GM 戰力基準測試 V9／分批執行 API 未完整載入",{version:window.GM_POWER_BENCHMARK_VERSION,batch:window.GM_POWER_BENCHMARK_BATCH_SIZE,output:typeof window.gmPowerBenchmarkRunOutput,defense:typeof window.gmPowerBenchmarkRunDefense,combat:typeof window.gmPowerBenchmarkRunCombat,busy:typeof window.gmPowerBenchmarkIsBusy,summary:typeof window.gmPowerBenchmarkSummaryText,copy:typeof window.gmPowerBenchmarkCopySummary,reset:typeof window.gmPowerBenchmarkReset});
