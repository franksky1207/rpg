(function(){
 ...
 if(Number(window.GM_SECOND_WORLD_CALAMITY_VERSION)!==1||Number(window.GM_SECOND_WORLD_CALAMITY_FORMAL_VERSION)!==1||Number(window.GM_SECOND_WORLD_CALAMITY_TEST_VERSION)!==1||Number(window.GM_SECOND_WORLD_CALAMITY_INTEGRITY_VERSION)!==1||window.GM_SECOND_WORLD_CALAMITY_INTEGRITY?.passed!==true||typeof window.gmSecondWorldCalamityManagementHtml!=="function"||typeof window.gmSecondWorldCalamityTestHtml!=="function"||typeof window.gmSyncCivilizationFromCalamities!=="function")fail("GM_SECOND_WORLD_CALAMITY","宇宙文明災厄 GM 管理／沙盒／Benchmark V1 未完整載入",{version:window.GM_SECOND_WORLD_CALAMITY_VERSION,formal:window.GM_SECOND_WORLD_CALAMITY_FORMAL_VERSION,test:window.GM_SECOND_WORLD_CALAMITY_TEST_VERSION,integrity:window.GM_SECOND_WORLD_CALAMITY_INTEGRITY});
