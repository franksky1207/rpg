(function(){
 ...
 if(Number(window.PLAYER_TITLE_UI_VERSION)!==1||Number(window.GM_PLAYER_TITLE_PREVIEW_VERSION)!==3)fail("PLAYER_TITLE_GM_PREVIEW","玩家稱號 UI V1／GM 實戰名稱預覽 V3 未載入",{ui:window.PLAYER_TITLE_UI_VERSION,gm:window.GM_PLAYER_TITLE_PREVIEW_VERSION});
 if(Number(window.PLAYER_TITLE_INTEGRITY_VERSION)!==4||window.PLAYER_TITLE_INTEGRITY?.passed!==true)fail("PLAYER_TITLE_INTEGRITY","玩家稱號專屬 integrity V4 未通過",window.PLAYER_TITLE_INTEGRITY?.errors||null);
