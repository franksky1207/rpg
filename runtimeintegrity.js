(function(){
 ...
 if(Number(window.SECOND_WORLD_CALAMITY_COMBAT_VERSION)!==1||Number(window.SECOND_WORLD_CALAMITY_SETTLEMENT_VERSION)!==1||Number(window.SECOND_WORLD_CALAMITY_CONTINUOUS_VERSION)!==1||Number(window.SECOND_WORLD_CALAMITY_UI_VERSION)!==1||Number(window.SECOND_WORLD_CALAMITY_APPEARANCE_NOTICE_VERSION)!==1||typeof window.runSecondWorldCalamityBattle!=="function"||typeof window.runSecondWorldCalamityContinuous!=="function"||typeof window.secondWorldCivilizationCalamityPageHtml!=="function")fail("SECOND_WORLD_CALAMITY_BATCH2","第二世界文明災厄戰鬥／結算／連戰／玩家 UI／現身通知 V1 未完整載入");
