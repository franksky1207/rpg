(function(){
 ...
 if(typeof window.gmHubRegisteredSectionIds==="function"){
  ...
  const testExpected=["player-ability-test","power-benchmark-test","second-world-calamity-test","bounty-test","arena-test","void-test","mirror-test","calamity-test","player-title-preview","gm-story-test"];
