(function(){
 ...
 if(Number(window.PLAYER_TITLE_INTEGRITY_VERSION)!==8||window.PLAYER_TITLE_INTEGRITY?.passed!==true)fail("PLAYER_TITLE_INTEGRITY","玩家稱號最終26稱號 integrity 未通過",window.PLAYER_TITLE_INTEGRITY?.errors||null);
 ...
 if(Number(window.PLAYER_TITLE_UNIVERSE_VISUAL_INTEGRITY_VERSION)!==1||window.PLAYER_TITLE_UNIVERSE_VISUAL_INTEGRITY_REPORT?.passed!==true)fail("PLAYER_TITLE_UNIVERSE_VISUAL_INTEGRITY","宇宙／鏡像稱號顯示 integrity 未通過",window.PLAYER_TITLE_UNIVERSE_VISUAL_INTEGRITY_REPORT?.errors||null);
