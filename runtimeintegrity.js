(function(){
 ...
 if(Number(window.GM_POWER_BENCHMARK_VERSION)!==3||typeof window.gmPowerBenchmarkRunOutput!=="function"||typeof window.gmPowerBenchmarkRunDefense!=="function"||typeof window.gmPowerBenchmarkRunCombat!=="function"||typeof window.gmPowerBenchmarkSummaryText!=="function"||typeof window.gmPowerBenchmarkCopySummary!=="function")fail("GM_POWER_BENCHMARK","GM 戰力基準測試 V3／摘要 API 未完整載入",{version:window.GM_POWER_BENCHMARK_VERSION,output:typeof window.gmPowerBenchmarkRunOutput,defense:typeof window.gmPowerBenchmarkRunDefense,combat:typeof window.gmPowerBenchmarkRunCombat,summary:typeof window.gmPowerBenchmarkSummaryText,copy:typeof window.gmPowerBenchmarkCopySummary});
