(function(){
 ...
 if(Number(window.CALAMITY_UI_VERSION)!==3||Number(window.CALAMITY_MINIMAL_MODE_VERSION)!==1||Number(window.CALAMITY_CONTINUOUS_GAP_MS)!==350)fail("CALAMITY_UI_VERSION","文明災厄 UI／極簡模式／場間節奏異常",{ui:window.CALAMITY_UI_VERSION,minimal:window.CALAMITY_MINIMAL_MODE_VERSION,gap:window.CALAMITY_CONTINUOUS_GAP_MS});
