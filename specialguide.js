(function(){
 ...
 function sgGuideHtml(){
  ...
  return `<details class="card" style="margin-top:14px"><summary style="cursor:pointer"><b>✦ 特殊遭遇說明</b></summary><div class="notice" style="margin-top:12px"><b>特殊遭遇規則</b><div class="muted" style="margin-top:6px">一般怪與菁英戰鬥中，每場約有 ${rate}% 機率出現未知特殊遭遇；Boss 不會觸發。HP 低於 30% 時不會出現。選擇挑戰後會先回滿 HP，再揭露並挑戰特殊怪；特殊戰鬥結束後，原本連續戰鬥會直接結束。選擇略過則不回血，並結束剩餘連戰。</div></div><div style="margin-top:12px"><b>特殊怪</b>${sgMonsterListHtml()}</div></details>`;
 }
