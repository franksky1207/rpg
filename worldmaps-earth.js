(function(){
 const EARTH_MAPS=[
  ...
  {chapter:"地球戰爭",name:"地下軍事設施",min:11,max:15,gear:["試作振動刃","地堡密封盔","實驗型護甲","封鎖區戰靴","軍規解碼器"],enemies:[["維修戰鬥機器",11,"normal","balanced"],["地堡守衛",12,"normal","tank"],["生化突擊兵",13,"normal","attack"],["地下重裝機甲",14,"elite","tank"],["設施防衛核心",15,"boss","balanced"]]},
  {chapter:"地球戰爭",name:"荒漠戰區",min:16,max:20,gear:["沙暴斬刀","防砂戰術盔","沙地複合甲","荒漠疾行靴","熱源追獵器"],enemies:[["沙地偵察兵",16,"normal","attack"],["輕型戰車",17,"normal","tank"],["火力支援兵",18,"normal","balanced"],["重型主戰機甲",19,"elite","tank"],["荒漠戰區統帥",20,"boss","balanced"]]},
  {chapter:"地球戰爭",name:"污染禁區",min:21,max:25,gear:["蝕毒軍刃","全罩防化面盔","生化隔離甲","污染區封閉靴","異變偵測器"],enemies:[["異變感染者",21,"normal","attack"],["防化突擊兵",22,"normal","balanced"],["污染獵殺獸",23,"normal","attack"],["生化重裝兵",24,"elite","tank"],["污染母體",25,"boss","tank"]]},
  {chapter:"地球戰爭",name:"極地戰線",min:26,max:30,gear:["霜鋼長刃","極寒封閉盔","冰原保溫甲","雪地抓地靴","熱源定位器"],enemies:[["雪域哨兵",26,"normal","balanced"],["霜牙獵殺機",27,"normal","attack"],["白原重裝兵",28,"normal","tank"],["冰脊攻城獸",29,"elite","tank"],["極寒戰爭巨像",30,"boss","tank"]]},
  ...
  {chapter:"地球戰爭",name:"地球決戰區",min:46,max:50,gear:["終戰斷界刃","終戰主控盔","征服者重甲","最終突擊靴","地球主控權限"],enemies:[["終戰突擊兵",46,"normal","attack"],["高階戰鬥機甲",47,"normal","balanced"],["戰爭人工智慧體",48,"normal","tank"],["終極重裝將軍",49,"elite","balanced"],["地球征服核心",50,"boss","tank"]]}
 ];
