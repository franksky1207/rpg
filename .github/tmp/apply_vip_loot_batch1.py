...
replace_once(
    "index.html",
'''<script src="vipprogression.js?v=20260920-vip-base1000"></script><script src="dailycore.js?v=20260914-cleanup3"></script>''',
'''<script src="vipprogression.js?v=20260920-vip-base1000"></script><script src="viplootcore.js?v=20260925-vip-loot-batch1"></script><script src="dailycore.js?v=20260914-cleanup3"></script>''')
replace_once("index.html", 'engine.js?v=20260922-death-no-exp-batch1', 'engine.js?v=20260925-vip-loot-batch1')
replace_once("index.html", 'traitdrop.js?v=20260914-maintenance1', 'traitdrop.js?v=20260925-vip-loot-batch1')
replace_once("index.html", 'dungeonbounty.js?v=20260924-universe-bounty-names1', 'dungeonbounty.js?v=20260925-vip-loot-batch1')

# Batch-1 structural integrity: owner exists, loads before all consumers, consumers no longer own VIP8/14/16/18 thresholds.
p=Path("tests/runtime/js-integrity.js")
s=p.read_text()
s=s.replace('const inventoryFocus=read("inventoryfocus.js");', 'const inventoryFocus=read("inventoryfocus.js");\nconst vipLootCore=read("viplootcore.js");\nconst traitDrop=read("traitdrop.js");\nconst engine=read("engine.js");')
...
'''
if anchor not in s:
    raise SystemExit("missing js-integrity insertion anchor")
