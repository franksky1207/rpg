(function(){
 ...
 if(Number(window.BACKGROUND_PROGRESS_VISIBILITY_OWNER_VERSION)!==1)fail("BOSS_BACKGROUND_VISIBILITY_OWNER",`BACKGROUND_PROGRESS_VISIBILITY_OWNER_VERSION 應為 1，實際 ${window.BACKGROUND_PROGRESS_VISIBILITY_OWNER_VERSION}`);
