...
- 目前第 1 隻為 33600／5600／2800，第 100 隻為 83496／13916／6958。
...
- 2026-09-23 將 `BASE_STAT` 進一步調整為 2800，作為前期難度實機測試版本；12:2:1 與 `STEP_RATE=.015` 不變。後續若仍要調前期難度只改 `BASE_STAT`，若要改後期成長速度再調 `STEP_RATE`。
