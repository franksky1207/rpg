...
<script src="dungeonarena.js?v=20260908-2255"></script>
...
...
經第一次 GM ×100 實測：
- 普通全通約 100%，平均積分約 160 → 太容易
- 困難全通約 30～40%，平均積分約 140～150 → 過難
- 極限全通約 0～5%，平均積分約 100 → 幾乎不可通關

因此已做第一輪正式再平衡；**目前有效數值如下**：
...
目前再平衡後仍以以下 full-clear 區間作為調整目標：
- 普通：80～90%
- 困難：55～70%
- 極限：30～45%

**這些是目標，不是保證值。** 下一輪仍由玩家實際跑 GM ×100 再決定是否微調。
