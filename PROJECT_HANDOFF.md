...
<script src="dungeonarena.js?v=20260908-2330"></script>
...
...
歷次 GM ×100 實測曾出現：
- 初版：普通約100%、困難30～40%、極限0～5%。
- 第二輪：普通90～95%、困難75%、極限15～30%。
- 第三輪：普通100%、平均150～155；困難50～60%、平均160～170；極限35～45%、平均200～210。
- 第四輪（困難放鬆後）：困難平均約185～195，略高於目標。

普通與極限目前已接受；困難目標仍為平均約 **175～185**，因此做最後一輪小幅加強。**目前有效數值如下**：
...
- `dungeonarena.js` 已因實測再平衡並 bump cache。
