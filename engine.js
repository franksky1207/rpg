...
/* Canonical save normalizers used by runtime load, import and rollback recovery. */
...
window.isImportableSave=isImportableSave;
window.normalizeSaveState=normalizeSaveState;
window.normalizeCurrentSaveState=normalizeCurrentSaveState;
