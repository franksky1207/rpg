(function(){
 const REGION_MAPS=[
  {chapter:"獵戶臂戰爭",name:"獵戶臂前線",min:201,max:205,gear:["獵戶星刃","旋臂戰盔","星區主戰甲","獵戶躍遷靴","旋臂導航標"],enemies:[["獵戶星兵",201,"normal","attack"],["旋臂警戒機",202,"normal","balanced"],["星區突擊體",203,"normal","tank"],["獵戶堡壘艦",204,"elite","tank"],["旋臂前線司令",205,"boss","balanced"]]},
  {chapter:"獵戶臂戰爭",name:"星門防衛區",min:206,max:210,gear:["星門切割刃","門衛戰盔","星門防護甲","空間穿越靴","星門控制節點"],enemies:[["星門鎮守兵",206,"normal","balanced"],["空間攔截機",207,"normal","attack"],["門區炮衛",208,"normal","tank"],["星門鎮壓體",209,"elite","attack"],["星門防衛中樞",210,"boss","tank"]]},
  ...
  {chapter:"獵戶臂戰爭",name:"星區軍械庫",min:231,max:235,gear:["軍械震裂刃","兵器庫戰盔","軍規重甲","武裝推進靴","軍械火控節點"],enemies:[["軍械守衛機",231,"normal","balanced"],["兵器庫巡邏兵",232,"normal","attack"],["軍械執行體",233,"normal","tank"],["大型兵器平台",234,"elite","attack"],["星區軍械中樞",235,"boss","tank"]]},
  {chapter:"獵戶臂戰爭",name:"獵戶臂要塞",min:236,max:240,gear:["要塞重刃","堡壘戰盔","要塞重裝甲","堡區機動靴","要塞權限模組"],enemies:[["堡壘戍衛兵",236,"normal","balanced"],["堡壘炮衛",237,"normal","tank"],["裝甲星兵",238,"normal","attack"],["要塞破城巨兵",239,"elite","tank"],["獵戶要塞中樞",240,"boss","balanced"]]},
